...
class IPv6Address(InterfaceAddress):
    ...
    def getzone(self):
        ...
        # Valid interface. Note that multiple interfaces sharing one link have the same scope zone
        return zone_id
...
def get_interface_addresses(ifname, fam=GIA_AF_ALL, scope=GIA_SCP_ALL):
...
def get_interface_address(ifname, fam=GIA_AF_ALL, scope=GIA_SCP_ALL):
...
def find_interface_address(addr, fam=GIA_AF_ALL, ifname=None):
...
def print_interface_addresses(ifname, fam=GIA_AF_ALL, scope=GIA_SCP_ALL):
...
def print_interface_address(ifname, fam=GIA_AF_LINK, scope=GIA_SCP_ALL, zone=True):
